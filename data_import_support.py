...
def add_new_to_old_csv(exc=0):
    ...
    if exc == 1:
        ...
        month_list = []
        start_date = "01.02.2015 00:00"
        start_unix = 1422748800
        end_unix = 1514764740
    else:
    ...
    start_index = time_old.index(start_unix)  # Tilsvarer 01.01.2017
    if end_unix == 0:
    ...
    print(time_list[0:3], time_list[-3:-1])
