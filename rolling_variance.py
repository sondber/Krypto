...
#The lenght of the output will be 2 * (len(returns)/unit_rolling), and the time-stamp will be the start of the window
#Be aware that the returns[0] is set to 0 for completeness of vector lengths
