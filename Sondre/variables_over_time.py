...
illiq_days_clean, log_illiq_days_clean, volatility_days_clean, log_volatility_days_clean = dis.clean_trans_days(
    time_list_minutes, prices_minutes, volumes_minutes, full_week=1, exc=exc)
...
if unedited == 1:
    ...
    # Realized volatility
    volatility_days, rVol_time = realized_volatility.RVol(time_list_minutes, prices_minutes[0, :], daily=1, annualize=1)
