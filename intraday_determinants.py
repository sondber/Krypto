...
for exc in exchanges:
    ...
    for bench_type in bench_types:
        ...
        if spread_determinants == 1:
            ...
            m_col = 0
            # Benchmark
            m_col, coeff_matrix, std_errs_matrix, p_values_matrix, rsquared_array, aic_array, n_obs_array = supp.import_regressions(m_col, Y, X_benchmark, coeff_matrix, std_errs_matrix, p_values_matrix, rsquared_array, aic_array, n_obs_array, prints=benchmark_only, intercept=intercept)
            supp.print_n(26)
