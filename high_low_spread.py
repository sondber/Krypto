...
def hi_lo_spread(timestamps, highs, lows,
                 kill_output=0):  # returns daily spreads, spread is set to zero if lack of data (as with rolls)
    ...
    if kill_output == 0:
        print("Calculating Hi/Lo-spread on a/an", freq_desc, "basis using", day_desc, "data")
